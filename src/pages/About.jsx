...
const About = () => {
  ...
  const testimonials = [
    {
      ...
      text: "Roupas extravagantes são incríveis! Encontrei a roupa perfeita para minha ocasião especial e a entrega foi super rápida.",
    },
    
    {
      ...
      text: "A qualidade dos produtos é incrível. Sempre encontro tudo o que preciso aqui, e a experiência de compra é excelente!",
    },
    {
      name: "Rahul Tiwari",
      ...
      text: "O atendimento ao cliente foi impecável, e fazer compras no site foi rápido e fácil. Recomendo muito!",
    },
    {
      name: "Abhay Mehta",
      ...
      text: "Entrega super rápida e preços ótimos! Já indiquei para todos os meus amigos e familiares.",
    },
    {
      name: "Sarah Wilson",
      photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwe4kzPRLWNBj34mlrylYKJ2O5IUJwXbQjGA&s",
      text: "Adoro a variedade de produtos. Tem algo para todo mundo, e o serviço é simplesmente imbatível!",
    },
  ];
  ...
  return (
      <div>
        ...
        >
          <img
            className="max-w-[450px] rounded-lg shadow-lg"
            src={assets.about_img}
            alt="Sobre nós"
          />
          <div className="flex flex-col justify-center gap-6 w-full md:w-2/4 text-gray-600">
            <p>
              A <span className="font-bold text-purple-700">SHOP PLUS</span> nasceu da paixão por inovação e diversidade. Desde nossa fundação em{" "}
              <span className="font-bold">2024</span>, nossa missão é conectar pessoas com produtos que tornam suas vidas melhores, mais simples e mais felizes.
            </p>
            <p>
              Oferecemos uma experiência de compra sem complicações, trazendo tudo o que você precisa: tecnologia, moda, utensílios domésticos, brinquedos, e muito mais.
            </p>
            <div>
              <b className="text-purple-700 text-xl">Nossa Visão</b>
              <p className="mt-4">
                Queremos nos consolidar como referência global em comércio eletrônico, oferecendo qualidade, confiança e uma experiência única para nossos clientes.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <b className="text-purple-700 text-xl">Garantia de Qualidade</b>
            <p className="text-gray-600 mt-4">
              Cada produto é cuidadosamente selecionado e avaliado para garantir a melhor experiência. Da escolha de materiais à entrega, qualidade é nossa prioridade.
            </p>
          </div>

          {/* Comodidade */}
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <b className="text-purple-700 text-xl">Comodidade</b>
            <p className="text-gray-600 mt-4">
              Nossa interface intuitiva permite que você encontre tudo o que precisa com facilidade. Produtos diversos, ofertas exclusivas e entrega rápida.
            </p>
          </div>

          {/* Atendimento ao Cliente */}
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <b className="text-purple-700 text-xl">Atendimento ao Cliente</b>
            <p className="text-gray-600 mt-4">
              Nossa equipe está sempre pronta para ajudar. Garantimos suporte dedicado para resolver suas dúvidas e oferecer uma experiência incrível.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <b className="text-purple-700 text-xl">Inovação</b>
            <p className="text-gray-600 mt-4">
              Estamos sempre na vanguarda, trazendo novidades e aprimorando constantemente nossos produtos e serviços para atender suas expectativas.
            </p>
          </div>
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <b className="text-purple-700 text-xl">Foco no Cliente</b>
            <p className="text-gray-600 mt-4">
              Seu bem-estar é nosso maior objetivo. Trabalhamos incansavelmente para melhorar sua experiência, ouvindo seu feedback e respondendo suas necessidades.
            </p>
          </div>
          <div className="p-6 bg-white shadow-lg rounded-lg">
            <b className="text-purple-700 text-xl">Sustentabilidade</b>
            <p className="text-gray-600 mt-4">
              Adotamos práticas responsáveis para minimizar nosso impacto ambiental, promovendo um futuro mais sustentável para todos.
            </p>
          </div>
        </motion.div>
